...
def measure_pupil_diameter_from_notebook(pupil_radius_px: int, 
    ...
    This method automatically accounts for image resolution because
    both pupil and iris scale proportionally with resolution.
    ...
    Notes:
    ------
    Resolution independence: Using iris as reference automatically handles
    different image resolutions. High-res images have more pixels for BOTH
    iris and pupil, so their ratio (and mm conversion) stays constant.
    
    The key assumption is accurate iris detection. If iris radius is wrong,
    all measurements will be scaled incorrectly.
    """
    ...
    # This works at any resolution because iris is always ~12mm
