...
JACKPOT_CONFIG = {
    ...
    # Iris detection parameters (needed by notebook functions!)
    'MIN_IRIS_RADIUS': 80,
    'MAX_IRIS_RADIUS': 250,
    'CANNY_LOW': 50,               # MISSING - Added for notebook compatibility
    'CANNY_HIGH': 150,             # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM1': 50,       # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM2': 30,       # MISSING - Added for notebook compatibility
    
    # Legacy Hough params (keep for backwards compat)
    'HOUGH_DP': 1.2,
    'HOUGH_MIN_DIST': 100,
    'HOUGH_PARAM1': 50,
    'HOUGH_PARAM2': 30
...
HIGH_PASS_CONFIG = {
    ...
    'MIN_IRIS_RADIUS': 60,
    'MAX_IRIS_RADIUS': 300,
    'CANNY_LOW': 40,               # MISSING - Added for notebook compatibility
    'CANNY_HIGH': 120,             # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM1': 50,       # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM2': 25,       # MISSING - Added for notebook compatibility
...
RESCUE_CONFIG = {
    ...
    'MIN_IRIS_RADIUS': 40,
    'MAX_IRIS_RADIUS': 350,
    'CANNY_LOW': 30,               # MISSING - Added for notebook compatibility
    'CANNY_HIGH': 100,             # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM1': 30,       # MISSING - Added for notebook compatibility
    'IRIS_HOUGH_PARAM2': 20,       # MISSING - Added for notebook compatibility
